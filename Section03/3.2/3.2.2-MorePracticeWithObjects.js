...
car.collections = [2008, 2009, 2010, 2011]
...
console.log('My favorite movie is ${obj.favorites.movie} and Ive watched it ${obj.favorites.number}  times wear a ${obj.favorites.color} shirt ')
