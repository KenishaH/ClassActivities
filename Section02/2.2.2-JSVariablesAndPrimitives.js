...
let favoriteSong = " Kash Page Love Songs";
...
let favoriteThing = " Go to dog parks ";
// You heard a new song that became your favorite.
// Reassign the variable "favoriteSong"
favoriteSong = " Summer Walker Girls need love";
...
console.log(
  "My name is " + name + "and my favorite song is " + favoriteSong + "."
);
